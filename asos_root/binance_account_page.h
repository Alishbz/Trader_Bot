 ...
 *
 *****************************************************************************/
#ifndef _BINANCE_ACCOUNT_PAGE_H
#define _BINANCE_ACCOUNT_PAGE_H
...
#define BINANCE_ACC_MA_INDEX_1   7
#define BINANCE_ACC_MA_INDEX_2   25
#define BINANCE_ACC_MA_INDEX_3   99

#define BINANCE_ORDER_ID  "asosxxx47174asos"



// TODO bunun alma satma ve cüzdan okuma gibi rest_api processlerini eklemek lazım !!
class binance_account_page_c : public QWidget ,public account_interface {
    Q_OBJECT

public:
    binance_account_page_c(QWidget*                 parent = nullptr ,
        ...
        _rest_api(rest_api)
    {
        ...
        if(_web_socket){
            ...
            QObject::connect(_web_socket, &binance_web_socket_c::coin_price_update,
                             this, &binance_account_page_c::async_candle_data_update);
        ...
        connect(timer, &QTimer::timeout, this, &binance_account_page_c::one_second_timer_callback);
        timer->start(1000);
    }
...
private:  // functions
    ...
    void direct_buy_order(){
        if( _is_buy_enable == false){
            emit log_print(" BINANCE: buy order: coin current price: " + QString::number( _last_coin_price));
            _is_buy_enable = true;
    ...
    void direct_sell_order(){
        if( _is_buy_enable){
            emit log_print(" BINANCE: account sell order: coin current price: " + QString::number( _last_coin_price));
        ...
        QTimer::singleShot(1000, this, [=]() {
            if (_web_socket) {
                ...
                QTimer::singleShot(1000, this, [=]() {
                    ...
                    emit log_print("BINANCE: coin selection DONE");
                });
            }
        });
    }
...
private:  // ex datas
    ...
    trader_c _trader;
    simple_mx_strategy_c * _strategy_smx_1;
    simple_mx_strategy_c * _strategy_smx_2;
    simple_mx_strategy_c * _strategy_smx_3;
    ...
    void _params_init_create(){
        ...
        // create containers
        _RSI_MA_container_1 = new OHLC_container(BINANCE_ACC_MA_INDEX_1);
        _RSI_MA_container_2 = new OHLC_container(BINANCE_ACC_MA_INDEX_2);
        _RSI_MA_container_3 = new OHLC_container(BINANCE_ACC_MA_INDEX_3);
    }
...
private:  // widget datas
    ...
    void _load_design_page(QVBoxLayout* main_layout){
            ...
            connect(start_strategy_button, &QPushButton::clicked,
                    this, [this]() {
                        ...
                        if (strategyName == "simple strategy mx1") {
                            ...
                            _strategy_smx_1 = new simple_mx_strategy_c(BINANCE_ACC_MA_INDEX_1 , this);
                            ...
                            _strategy_smx_2 = new simple_mx_strategy_c(BINANCE_ACC_MA_INDEX_2 , this);
                            ...
                            _strategy_smx_3 = new simple_mx_strategy_c(BINANCE_ACC_MA_INDEX_3 , this);
        ...
        QHBoxLayout *wallet_buy_sell_layout = new QHBoxLayout(this);
        {
            ...
            /** add to layout **/
            wallet_buy_sell_layout->addWidget(new QLabel("BINANCE Wallet:", this));
